!function (w) {
    ...
    let alipayIcon = '<img class="pay-icon alipay-icon" src="/assets/common/images/alipay.png?v=1" width="30" height="30" alt="支付宝">';
    alipaySvg = alipayIcon;
    let binanceIcon = '<img class="pay-icon binance-icon" src="/assets/common/images/binance.png?v=20260820-1" width="30" height="30" alt="币安">';
