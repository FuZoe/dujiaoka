...
return [
    ...
    'prompt' => [
        ...
        'payment_method_temporarily_unavailable' => '微信支付在夜间暂停时段暂不可用，请选择其他支付方式',
        'abnormal_payment_channel' => '支付网关异常！',
        'alipay_invalid_app_id' => '支付宝配置错误：请填写开放平台应用 APPID（通常为 16 位数字），不要填写“商户号”或支付宝账号。',
        'alipay_missing_public_key' => '支付宝配置错误：请填写支付宝公钥。',
        'alipay_missing_private_key' => '支付宝配置错误：请填写应用私钥。',
        'alipay_application_public_key_misconfigured' => '支付宝配置错误：支付宝公钥栏误填了应用公钥，请从开放平台复制“支付宝公钥”。',
        'alipay_permission_denied' => '支付宝应用未开通当前支付产品，或签约尚未生效。请在支付宝开放平台为该 APPID 开通电脑网站支付并确认签约主体一致后重试。',
        'alipay_generation_failed' => '支付宝支付暂时无法发起，请检查 APPID、支付宝公钥和应用私钥配置。',
