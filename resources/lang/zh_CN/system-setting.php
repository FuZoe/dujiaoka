...
return [
    ...
    'fields' => [
        ...
        'is_open_email_restock' => '补货邮件通知',
        'is_open_email_out_of_stock' => '商品售罄邮件通知',
        'email_restock_recipient' => '库存通知收件邮箱',
    ...
    'helps' => [
        ...
        'is_open_email_restock' => '批量导入卡密使库存增加时发送，每个导入批次最多一封邮件；邮件服务需先配置并测试成功。默认关闭。',
        'is_open_email_out_of_stock' => '商品库存从有货变为 0 时发送一封邮件；同一商品补货后会开启下一轮提醒。',
        'email_restock_recipient' => '默认发送到 fxq45@qq.com，可填写其他有效邮箱；售罄和补货邮件共用此地址。',
