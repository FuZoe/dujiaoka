...
return [
    ...
    'prompt' => [
        ...
        'payment_method_temporarily_unavailable' => '微信支付在夜間暫停時段暫不可用，請選擇其他支付方式',
        'abnormal_payment_channel' => '支付網關異常！',
        'alipay_invalid_app_id' => '支付寶配置錯誤：請填寫開放平台應用 APPID（通常為 16 位數字），不要填寫「商戶號」或支付寶帳號。',
        'alipay_missing_public_key' => '支付寶配置錯誤：請填寫支付寶公鑰。',
        'alipay_missing_private_key' => '支付寶配置錯誤：請填寫應用私鑰。',
        'alipay_application_public_key_misconfigured' => '支付寶配置錯誤：支付寶公鑰欄誤填了應用公鑰，請從開放平台複製「支付寶公鑰」。',
        'alipay_permission_denied' => '支付寶應用未開通當前支付產品，或簽約尚未生效。請在支付寶開放平台為該 APPID 開通電腦網站支付並確認簽約主體一致後重試。',
        'alipay_generation_failed' => '支付寶支付暫時無法發起，請檢查 APPID、支付寶公鑰和應用私鑰配置。',
